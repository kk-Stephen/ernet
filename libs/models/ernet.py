...
class ERNet(nn.Module):
    ...
    def __init__(self, 
        ...
        self.num_rel_classes = num_classes['rel_labels']
        ...
        if not two_stage:
            ...
            self.rel_query_embed = nn.Embedding(rel_num_queries, hidden_dim*2)
...
class SetCriterion(nn.Module):
    ...
    def loss_actions(self, outputs_dict, targets, indices_dict, num_boxes_dict, log=True,
                     neg_act_id=0, topk=3, alpha=0.25, gamma=2, loss_reduce='sum'):

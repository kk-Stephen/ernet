...
class hico():
    def __init__(self, qhacoq_dataset, train_qhacoq_dataset):
        self.annotations = qhacoq_dataset.hoi_annotations
        self.train_annotations = train_qhacoq_dataset.hoi_annotations
